  ...
  try {
    ...
    if (!message) {
      return res.status(400).json({
        success: false,
        message: ERROR_MESSAGES.CHAT.EMPTY_MESSAGE,
        type: "error",
      });
    }
    ...
    const systemPrompt = `You're a warm CBT therapist who uses emojis and humor 😊 
      ...
      Example: "That sounds really tough, getting criticism from a friend can sting 💔 
      I'm wondering if you're maybe catastrophizing a bit - like one negative comment = 
      whole project is bad? Try this: write down 3 things you like about your project to 
      balance out that one critique! ✨"`;
