...
const FAQSection = () => {
  ...
  return (
    <div id="faq-section" className="relative min-h-screen flex items-center justify-center py-16 px-4 bg-gradient-to-br from-slate-50 via-teal-50 to-cyan-50 overflow-hidden">
      
      {/* Floating Organic Elements — Like Clouds or Breath */}
      <div className="absolute top-10 left-10 w-32 h-32 bg-teal-200 rounded-full opacity-10 blur-3xl animate-blob"></div>
      <div className="absolute top-40 right-20 w-40 h-40 bg-cyan-200 rounded-full opacity-8 blur-3xl animate-blob delay-1000"></div>
      <div className="absolute bottom-32 left-1/4 w-28 h-28 bg-teal-200 rounded-full opacity-6 blur-3xl animate-blob delay-2000"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto backdrop-blur-xl bg-white/70 border border-white/30 rounded-3xl shadow-2xl p-8 md:p-12">
        ...
        <h1 className="text-center text-4xl md:text-5xl font-bold text-gray-800 mb-12 leading-tight relative">
          ...
          <span className="bg-gradient-to-r from-teal-600 via-teal-600 to-teal-600 bg-clip-text text-transparent">
            About Mental Health
          </span>
          
          {/* Subtle glowing underline */}
          <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-6 w-24 h-1 bg-gradient-to-r from-teal-500 to-purple-500 rounded-full shadow-lg shadow-teal-500/30"></div>
        </h1>
            ...
            <li key={index} className="group">
              <button
                ...
                className={`w-full text-left p-7 rounded-2xl border border-gray-100/50 transition-all duration-700 cursor-pointer relative overflow-hidden group-hover:border-blue-200/80 ${
                  expandedIndex === index
                    ? 'bg-gradient-to-r from-teal-50 to-indigo-50 border-teal-200/50 shadow-md'
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-teal-100/0 to-blue-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl pointer-events-none"></div>

                {/* Floating Wave Animation on Hover */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-teal-200/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl blur-sm pointer-events-none"></div>

                {/* Arrow Icon — Gently Opens Like a Petal */}
                <svg
                  className={`absolute right-6 top-1/2 transform -translate-y-1/2 w-6 h-6 text-gray-500 transition-transform duration-500 group-hover:text-teal-600 ${
              ...
              <div
                className={`overflow-hidden transition-all duration-800 ease-out ${
                  expandedIndex === index
                    ? 'max-h-[500px] opacity-100 mt-4 p-6 rounded-2xl bg-gradient-to-br from-gray-50 to-teal-50 border border-gray-100/30 shadow-inner'
              ...
              >
                ...
                <div className="mt-4 flex items-center text-xs text-gray-500 italic">
                  <span className="w-2 h-2 bg-teal-300 rounded-full animate-pulse mr-2"></span>
        ...
        <div className="mt-12 text-center pt-8 border-t border-gray-100/30">
          <p className="text-gray-600 text-lg italic leading-relaxed">
            ...
            <span className="text-teal-600 font-medium">— Vibes Community</span>
          </p>
        </div>
      </div>

      {/* Floating Bubbles — Like Thoughts Rising */}
      <div className="absolute top-1/3 left-1/3 w-2 h-2 bg-teal-300 rounded-full opacity-20 animate-bounce delay-1000"></div>
