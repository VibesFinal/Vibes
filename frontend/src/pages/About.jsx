...
export default function About() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-white p-8">
      <div className="max-w-3xl bg-white border-2 border-teal-300 rounded-2xl p-10 shadow-lg shadow-teal-200/30 text-center">
        <p className="text-lg leading-relaxed text-gray-800 font-normal font-sans">
          <span className="text-4xl font-bold text-teal-400 mt-1">H</span>
